...
<form id="DefineDataSet" action="Learning Styles.php" method="POST"><br>
<input class="SaveDSButton glow" style="width: 
400px" type="submit" name="act_ref" value="Calculate Active/ Reflective Learning Style preferences">      <br>  <br>  <input class="SaveDSButton glow" style="width: 
400px" type="submit" name="sens_int" value="Calculate Sensing/ Intuitive Learning Style preferences"><br><br>
<input class="SaveDSButton glow" style="width: 
400px" type="submit" name="seq_glob" value="Calculate Sequential/ Global Learning Style preferences">   <br><br> 
<input class="SaveDSButton glow" style="width: 
400px"  type="submit" name="vis_ver" value="Calculate Visual/ Verbal Learning Style preferences">
...
if(isset($_POST['act_ref']))
{
   echo "<script> window.location.href='ActiveReflective.php'; </script>" ;
}
else if(isset($_POST['sens_int']))
{
    echo "<script> window.location.href='SensingIntuitive.php'; </script>";
}
else if (isset($_POST['vis_ver']))
{
    echo "<script> window.location.href='VisualVerbal.php'; </script>";
}
else if(isset($_POST['seq_glob']))
{
    echo "<script> window.location.href='SequentialGlobal.php'; </script>";
}
