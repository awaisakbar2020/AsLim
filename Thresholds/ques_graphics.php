...
{  
  ...
  { 
    ...
    if (in_array($teachers_courses[$j], $courses))
    {
        ...
        echo "<br>";
        echo "total_correctly_answered_graphical_ques: $total_correctly_answered_graphical_ques";
        echo "<br>";
    //---------------------------------
    //q4 etc should be inside the loop
    //---------------------------------
        echo "total_graphical_ques_in_course: $total_graphical_ques_in_course";
        echo "<br>";
    ...
    for($m=0;$m<$len_teachers_courses;$m++)
    {
        ...
        while($n<$spliter[$m])
        {
            ...
            echo "$hint_value_ques_graphics[$n]";
