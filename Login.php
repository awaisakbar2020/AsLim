...
<div class="messages status"><p class="helptext"><em>AsLim - Affective States and Learning Styles Identification and Measurement Tool is a tool for automatic detection of the affective states and the learning styles from students' behavior and preferences in Learning Management Systems. This tool has been developed to facilitate the teachers so that they can get the proper feedback about how their students are behaving in a course and to help the course designers in the identification of the difficult and inappropriate learning material. AsLim is keeping track of the students' behavior by using their data stored in Moodle databases.</em></p></div>
<div id="CenterContent" class="content"><div id="loginform" style="clear: left;"><form action="Login.php" method="POST">
<table>
...
<div class="content"><p class="helptext">Please enter your Moodle user name and password
		    then click the 'Login' button.<br><br>Contact your Moodle site administrator for any login issues.
