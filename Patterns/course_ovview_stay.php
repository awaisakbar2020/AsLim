...
$result= mysqli_query($con,"SELECT id,userid,time FROM mdl_log WHERE module='course' AND action='view'");
...
for($x=0;$x<$arrlength;$x++)
{
  ...
  while($module=='course')
  {
      ...
      $result2=mysqli_query($con,"select module,userid,time from mdl_log where id='$id'");
...
$len_duration=count($useridArray);
...
{
    echo"<br>";
    echo "Course Overview Stay of user id $final_useridArray[$f_s] is: ";
        echo $forum_stay[$f_s];
    echo"<br>";
}
