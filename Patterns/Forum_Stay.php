...
$result= mysqli_query($con,"SELECT id,userid,time FROM mdl_log WHERE module='forum' AND action='view forum'");
...
{
    echo"<br>";
    echo "Forum Stay of user id $final_useridArray[$f_s] is: ";
        echo $forum_stay[$f_s];
    echo"<br>";
}
